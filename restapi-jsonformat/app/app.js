...
app.factory("services", ['$http', function($http) {
  var serviceBase = 'services/'
	...
	obj.updateCustomer = function (id,customer) {
	    return $http.post(serviceBase + 'updateCustomer', {id:id, customer:customer}).then(function (results) {
...
app.controller('listCtrl', function ($scope, services) {
      ...
      $scope.show_jsontext = 'Hide Json';

    $scope.showhide_jsonformat = function() {
      $scope.jsonfomat_box =  ($scope.show_jsontext =='Show Json') ? false : true;

      $scope.show_jsontext = ($scope.show_jsontext =='Hide Json')  ? 'Show Json': 'Hide Json';
    }
